...
if __name__=="__main__":
    ...
    parser.add_argument("--mirror", help="Whether or not to run calculations for original class average and its mirror image (defaults to False)", action='store_true') #defaults to False 
