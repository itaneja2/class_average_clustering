...
def rot_trans_invariant_dist_optimized(image_2d_rotation_matrix_map, image_2d_rotation_matrix_max_shape_map, img1_idx, img2_idx):
    ...
    #to ignore background noise when calculating edges 
    img2_shifted[img2_shifted < (float(threshold_otsu(cv2.GaussianBlur(img2_shifted,(11,11),0))))] = 0
    img1_cropped_padded[img1_cropped_padded < (float(threshold_otsu(cv2.GaussianBlur(img1_cropped_padded,(11,11),0))))] = 0
